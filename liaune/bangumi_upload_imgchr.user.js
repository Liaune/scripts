...
(function() {
    var g = {
        ...
        vendors: {
            ...
            ipb: {
                ...
                getEditorFn: function() {
                    var a = this.getEditor().dataset.ipseditorName;
                    return CKEDITOR.instances[a]
                },
                getEditor: function() {
                    return document.querySelector("[data-ipseditor-name]")
                },
                editorValue: function(a) {
                    a = CKEDITOR.dom.element.createFromHtml("<p>" + a + "</p>");
                    this.getEditorFn().insertElement(a)
                },
            ...
            mybb: {
                ...
                check: "MyBB",
                getEditor: function() {
                    return MyBBEditor ? MyBBEditor.getContentAreaContainer()[0].parentElement : document.querySelector("#quickreply_e textarea")
                },
                editorValue: function(a) {
                    if (MyBBEditor) {
                        var b = MyBBEditor.inSourceMode() ? "insert" : "wysiwygEditorInsertHtml";
                        MyBBEditor[b]("insert" == b ? a : MyBBEditor.fromBBCode(a))
                    } else
                        this.getEditor().value += a
                },
                useCustomEditor: function() {
                    return !!MyBBEditor
                }
            ...
            nodebb: {
                ...
                callback: function() {
                    for (var a = document.querySelectorAll(".btn-toolbar .img-upload-btn"), b = 0; b < a.length; b++)
            ...
            redactor2: {
                getEditor: function() {
                    var a = this.getEditorFn();
                    return a ? this.useCustomEditor() ? a.$box[0] : a[0] : null
                },
                getEditorEl: function() {
                    return this.useCustomEditor() ? this.getEditorFn().$editor[0] : this.getEditorFn()[0]
                },
                editorValue: function(a) {
                    var b = this.useCustomEditor() ? "innerHTML" : "value";
                    if ("string" == typeof a)
                        this.useCustomEditor() ? (b = "<p>" + a + "</p>",
                        this.getEditorFn().insert.html("" !== this.editorValue() ? "<p><br></p>" + b : b)) : this.getEditorEl()[b] = a;
                    else
                        return a = this.getEditorEl()[b],
                        this.useCustomEditor() && "<p><br></p>" == a ? "" : this.getEditorEl()[b]
                },
                useCustomEditor: function() {
            ...
            smf: {
                ...
                check: "smf_scripturl",
                getEditor: function() {
                    return 0 < smf_editorArray.length ? smf_editorArray[0].oTextHandle : document.querySelector(".quickReplyContent textarea")
                }
            },
            vanilla: {
                settings: {
            ...
            vbulletin: {
                ...
                check: "vBulletin",
                getEditorFn: function() {
                    var a = this.getEditor().getAttribute("ck-editorid");
                    return CKEDITOR.instances[a]
                },
                getEditor: function() {
            ...
            XF1: {
                ...
                check: "XenForo",
                getEditorFn: function() {
                    var a = document.querySelector("#exposeMask") && document.querySelector("#exposeMask").offsetParent ? ".xenOverlay form" : "form";
                    if ("form" !== a)
                        for (var b = document.querySelectorAll(a), c = 0; c < b.length; c++)
                            if (b[c].offsetParent) {
                                a += '[action="' + b[c].getAttribute("action") + '"]';
                                break
                            }
                    return XenForo.getEditorInForm(a)
                },
                getEditor: function() {
                    var a = this.getEditorFn();
                    return a ? this.useCustomEditor() ? a.$box[0] : a[0] : null
                ...
                editorValue: function(a) {
                    ...
                    if ("string" == typeof a)
                        this.useCustomEditor() ? (b = "<p>" + a + "</p>",
                        this.getEditorFn().insertHtml("" !== this.editorValue() ? "<p><br></p>" + b : b)) : this.getEditorEl()[b] = a;
                    else
                        return a = this.getEditorEl()[b],
                        this.useCustomEditor() && "<p><br></p>" == a ? "" : this.getEditorEl()[b]
                },
            ...
            XF2: {
                ...
                check: "XF",
                getEditorFn: function(a) {
                    var b = ".js-editor";
                    "string" == typeof a && (b = this.getEditorSel(a));
                    return XF.getEditorInContainer($(b))
                },
                getEditorSel: function(a) {
                    return "[" + g.ns.dataPluginTarget + '="' + a + '"]'
                },
                getEditor: function(a) {
                    return "string" == typeof a ? document.querySelector(this.getEditorSel(a)) : document.querySelectorAll(".js-editor")
                },
                getBbCode: function(a) {
                    return a.getTextArea()[0].value
                },
                editorValue: function(a, b) {
                    var c = this.getEditorFn(b)
                      , d = c.ed.bbCode.isBbCodeView() ? ["bbCode", "getBbCode", "insertBbCode"] : ["html", "get", "insert"]
                      , e = c.ed[d[0]];
                    if ("string" == typeof a) {
                        var f = "" !== this.editorValue(!1, b);
                        "html" == d[0] ? (c = "<p>" + a + "</p>",
                        e[d[2]](f ? "<p><br></p>" + c : c)) : XF.ajax("POST", XF.canonicalizeUrl("index.php?editor/to-bb-code"), {
                            html: a
                        }).done(function(a) {
                            e[d[2]](f ? "\n" + a.bbCode : a.bbCode)
                        })
                    } else
                        return c = "undefined" == typeof e[d[1]] ? this.getBbCode(e) : e[d[1]](),
                        this.useCustomEditor() && "<p><br></p>" == c ? "" : c
                },
                useCustomEditor: function() {
                    return "undefined" !== typeof XF.getEditorInContainer($(".js-editor"))
                }
            }
        },
                ...
                if ((new RegExp(a.originUrlPattern,"i")).test(c.origin) || "undefined" != typeof c.data.id && "undefined" != typeof c.data.message) {
                    ...
                    if (d && c.source === a.popups[d].window)
                        if (c.data.requestAction && a.hasOwnProperty(c.data.requestAction))
                            ...
                            if (!e && (e = document.querySelector("[" + a.ns.dataPluginTarget + '="' + d + '"]'),
                            !e)) {
      ...
      , h = 0;
    for (; h < m.length; h++)
        g.vendors[m[h]] = Object.assign(Object.assign({}, g.vendors.redactor2), g.vendors[m[h]]);
    g.prepare()
}
)();
